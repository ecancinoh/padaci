    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rol', models.CharField(choices=[('admin', 'Administrador'), ('supervisor', 'Supervisor'), ('conductor', 'Conductor'), ('operador', 'Operador')], default='operador', max_length=20, verbose_name='Rol')),
